...
EOF
	...
	echo -e "${nmfl}: Kesalahan URL/Bug/Domain!. Read https://github.com/boychongzen18/vmess-auto-singkron-jam/blob/main/README.md for details."
	logger "${nmfl}: Kesalahan URL/Bug/Domain!. Read https://github.com/boychongzen18/vmess-auto-singkron-jam/blob/main/README.md for details."
fi
